...
contextBridge.exposeInMainWorld("serviceControl", {
    ...
    getEnvironmentStatus: () => invoke("environments:get-status"),
    ...
    environmentServiceAction: (environmentId, action) => invoke("environment:service-action", environmentId, action),
    environmentComponentsAction: (environmentId, action) => invoke("environment:components-action", environmentId, action),
    environmentComponentAction: (environmentId, componentId, action) => invoke("environment:component-action", environmentId, componentId, action),
