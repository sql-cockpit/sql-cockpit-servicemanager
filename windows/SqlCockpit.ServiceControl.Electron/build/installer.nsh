!macro customInstall
  DetailPrint "Provisioning SQL Cockpit suite (desktop, service host, and tray task)..."
  ...
  Pop $0
  StrCmp $0 "0" done
    MessageBox MB_ICONSTOP|MB_OK "SQL Cockpit suite provisioning failed (exit code $0). Run the installer as Administrator and review setup logs under $INSTDIR\resources\setup\scripts."
    Abort
  done:
!macroend

!macro customUnInstall
  DetailPrint "Removing SQL Cockpit service host and tray startup task..."
